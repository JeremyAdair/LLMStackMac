...
- `services/python-toolbox/app/scripts/`
...
- `services/python-toolbox/app/api/`
...
1) Put your script or helper in `services/python-toolbox/app/scripts/<your_area>/`.
2) Add an endpoint in `services/python-toolbox/app/api/routes_<your_area>.py`.
3) Register the router in `services/python-toolbox/app/api/app.py`.

Example pattern:

```python
# services/python-toolbox/app/api/routes_jobs.py
...
```python
# services/python-toolbox/app/api/app.py
from api.routes_jobs import router as jobs_router
app.include_router(jobs_router)
```

To remove an API script, remove the endpoint and its router import/registration.
Because the container bind-mounts `services/python-toolbox/app`, changes take effect on
...
- Execution is only enabled for scripts under `services/python-toolbox/app/scripts/`.
